...
app.use('/api/dialogues', passport.authenticate("jwt", { session: false }), dialoguesRouter);
...
app.use('/api/attendance',passport.authenticate("jwt", {session: false}) ,attendanceRouter)
